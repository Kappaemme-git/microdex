...
data remains on your phone and Mac until you remove it. **Forget this Mac**
removes the phone copy. `microdex revoke-all` invalidates every paired phone and
rotates the Mac credential. `microdex uninstall --purge` removes local bridge
credentials and requests deletion of the durable relay room.
