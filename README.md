...
It runs on iOS through Expo and connects over
...
- The persistent bridge credential is returned only by the local pairing endpoint and is stored in the iOS Keychain by the app.
