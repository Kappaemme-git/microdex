...
- Confirm the custom icon notice is reachable from the app, retain the private
  permission evidence, and explain the independent branding and Codex App
  Server integration in Review Notes.
